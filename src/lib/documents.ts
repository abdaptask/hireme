...
/** Format a "submitted on" / "reviewed on" date relative to today, with year. */
function dateAgo(days: number): string {
  return formatDate(daysAgo(days), { withYear: true });
}

/** Format a forward-looking expiration date with year. */
function dateAhead(days: number): string {
  return formatDate(daysFromNow(days), { withYear: true });
}
...
export const DOCUMENTS: Document[] = [
  {
    ...
    category: "identity",
    status: "rejected",
    submittedDate: dateAgo(5),
    reviewedDate: dateAgo(5),
    reviewer: "AI Copilot",
    aiScore: 31,
  ...
  },
  {
    ...
    signatures: [
      ...
      { label: "Date stamp",          result: "pass", detail: dateAgo(4) },
  ...
  },
  {
    ...
    category: "tax",
    status: "approved",
    submittedDate: dateAgo(8),
    reviewedDate: dateAgo(7),
    ...
    signatures: [
      ...
      { label: "Date stamp",         result: "pass", detail: dateAgo(8) },
    ],
    crossDoc: [
  ...
  },
  {
    ...
    category: "client",
    status: "approved",
    submittedDate: dateAgo(7),
    reviewedDate: dateAgo(6),
    reviewer: "Riya Kim",
    aiScore: 99,
    aiFlags: [],
    version: 2,
  ...
  },
  {
    ...
    signatures: [
      ...
      { label: "Date stamp",         result: "pass", detail: dateAgo(6) },
  ...
  },
  {
    ...
    category: "employment",
    status: "approved",
    submittedDate: dateAgo(10),
    reviewedDate: dateAgo(9),
    reviewer: "Sasha Patel",
    aiScore: 98,
    aiFlags: [],
    version: 1,
  ...
  },
  {
    ...
    category: "compliance",
    status: "approved",
    submittedDate: dateAgo(17),
    reviewedDate: dateAgo(16),
    reviewer: "Lena Ortiz",
    aiScore: 95,
    aiFlags: [],
    version: 1,
  ...
  },
  {
    ...
    category: "employment",
    status: "approved",
    submittedDate: dateAgo(15),
    reviewedDate: dateAgo(14),
    reviewer: "Riya Kim",
    aiScore: 96,
    aiFlags: [],
    version: 1,
  ...
  },
  {
    ...
    extractedFields: [
      ...
      { label: "Expiration",      value: dateAgo(56),           confidence: 98, state: "needs-review" },
    ],
    validation: [
      ...
      { label: "Expiration check",        result: "fail", detail: `Expired 56 days ago (${dateAgo(56)})` },
      { label: "Tamper evidence check",   result: "pass", detail: "No artifacts detected" },
      { label: "Malware scan",            result: "pass" },
    ],
    signatures: [
  ...
  },
  {
    ...
    category: "employment",
    status: "approved",
    submittedDate: dateAgo(18),
    reviewedDate: dateAgo(17),
  ...
  },
  {
    ...
    extractedFields: [
      ...
      { label: "Expiration",    value: dateAhead(1012),        confidence: 89, state: "verified" },
    ...
    validation: [
      ...
      { label: "All 4 corners visible",   result: "pass" },
      { label: "Text readable",           result: "pass" },
      { label: "Expiration date detected", result: "pass", detail: `${dateAhead(1012)} — valid for 33 more months` },
