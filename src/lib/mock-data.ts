...
export const FEED_EVENTS: FeedEvent[] = [
  ...
  { id: "EVT-4804", time: "08:24:47", eventType: "Reminder Sent", candidate: "Liam Foster", client: "Atlas Manufacturing", stage: "Document Submission", owner: "AI Copilot", status: { kind: "pipeline", status: "waiting-external" }, sla: { label: "12h left", tone: "neutral" }, integration: "Sinch", ai: true, actionRequired: null },
