...
export const CANDIDATES: CandidateSummary[] = [
  {
    ...
    risk: "at-risk",
    startDateLabel: formatDate(daysFromNow(3)),
    startInDays: 3,
  ...
  },
  {
    ...
    status: "on-track",
    risk: "on-track",
    startDateLabel: formatDate(daysFromNow(10)),
    startInDays: 10,
  ...
  },
  {
    ...
    startDateLabel: formatDate(daysFromNow(6)),
    startInDays: 6,
    recruiter: "Devon Hughes",
  ...
  },
  {
    ...
    status: "at-risk",
    risk: "unlikely",
    startDateLabel: formatDate(daysFromNow(2)),
    startInDays: 2,
    recruiter: "Devon Hughes",
    onboarder: "Sasha Patel",
    progress: 38,
  ...
  },
  {
    ...
    status: "in-review",
    risk: "on-track",
    startDateLabel: formatDate(daysFromNow(13)),
    startInDays: 13,
    recruiter: "Aaron Flores",
    onboarder: "Riya Kim",
    progress: 72,
  ...
  },
  {
    ...
    status: "on-track",
    risk: "on-track",
    startDateLabel: formatDate(daysFromNow(18)),
    startInDays: 18,
    recruiter: "Aaron Flores",
    onboarder: "Sasha Patel",
    progress: 80,
  ...
  },
  {
    ...
    status: "in-review",
    risk: "on-track",
    startDateLabel: formatDate(daysFromNow(11)),
    startInDays: 11,
    recruiter: "Lena Ortiz",
    onboarder: "Riya Kim",
    progress: 58,
  ...
  },
  {
    ...
    status: "needs-attention",
    risk: "needs-attention",
    startDateLabel: formatDate(daysFromNow(7)),
    startInDays: 7,
    recruiter: "Lena Ortiz",
    onboarder: "Sasha Patel",
    progress: 49,
  ...
  },
  {
    ...
    status: "on-track",
    risk: "on-track",
    startDateLabel: formatDate(daysFromNow(24)),
    startInDays: 24,
    recruiter: "Aaron Flores",
    onboarder: "Riya Kim",
    progress: 86,
  ...
  },
  {
    ...
    status: "in-review",
    risk: "needs-attention",
    startDateLabel: formatDate(daysFromNow(12)),
    startInDays: 12,
    recruiter: "Lena Ortiz",
    onboarder: "Riya Kim",
    progress: 64,
  ...
  },
  {
    ...
    status: "on-track",
    risk: "on-track",
    startDateLabel: formatDate(daysFromNow(5)),
    startInDays: 5,
    recruiter: "Lena Ortiz",
    onboarder: "Riya Kim",
    progress: 82,
  ...
  },
  {
    ...
    status: "needs-attention",
    risk: "needs-attention",
    startDateLabel: formatDate(daysFromNow(9)),
    startInDays: 9,
    recruiter: "Aaron Flores",
    onboarder: "Riya Kim",
    progress: 34,
  ...
  },
  {
    ...
    status: "on-track",
    risk: "on-track",
    startDateLabel: formatDate(daysFromNow(16)),
    startInDays: 16,
    recruiter: "Aaron Flores",
    onboarder: "Sasha Patel",
    progress: 70,
