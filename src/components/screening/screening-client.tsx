...
const ADJUDICATION_CASES: AdjudicationCase[] = [
  ...
  },
  {
    ...
    screeningType: "Criminal — Standard 7yr",
    findingSummary: "Review required — 1 item",
    responsePeriodStatus: `Pre-adverse notice sent ${formatDate(daysAgo(3))}`,
    daysRemaining: 5,
...
const DRUG_TEST_RECORDS: DrugTestRecord[] = [
  {
    ...
    appointmentDate: formatDate(daysAgo(18), { withYear: true }),
  ...
  },
  {
    ...
    appointmentDate: formatDate(daysFromNow(1), { withYear: true }),
  ...
  },
  {
    ...
    appointmentDate: formatDate(daysFromNow(2), { withYear: true }),
  ...
  },
  {
    ...
    testType: "10-panel",
    collectionSite: "LabCorp — Midtown NY",
    appointmentDate: formatDate(daysAgo(5), { withYear: true }),
...
const EXPIRING_RECORDS: ExpiringRecord[] = [
  {
    ...
    completionDate: formatDate(daysAgo(12), { withYear: true }),
    expirationDate: formatDate(daysFromNow(18), { withYear: true }),
    daysUntilExpiry: 18,
  ...
  },
  {
    ...
    completionDate: formatDate(daysAgo(8), { withYear: true }),
    expirationDate: formatDate(daysFromNow(6), { withYear: true }),
    daysUntilExpiry: 6,
    expiryStatus: "expiring",
  },
  {
    ...
    client: "Meridian Health",
    screeningType: "Enhanced 10yr Background Check",
    completionDate: formatDate(daysAgo(4), { withYear: true }),
    expirationDate: formatDate(daysFromNow(26), { withYear: true }),
    daysUntilExpiry: 26,
    expiryStatus: "active",
  },
  {
    ...
    client: "Atlas Manufacturing",
    screeningType: "Enhanced 10yr Background Check",
    completionDate: formatDate(daysAgo(59), { withYear: true }),
    expirationDate: formatDate(daysAgo(7), { withYear: true }),
    daysUntilExpiry: -7,
  ...
  },
  {
    ...
    client: "Cobalt Systems",
    screeningType: "Standard 7yr Background Check",
    completionDate: formatDate(daysAgo(80), { withYear: true }),
    expirationDate: formatDate(daysAgo(4), { withYear: true }),
    daysUntilExpiry: -4,
    expiryStatus: "expired",
  },
];
